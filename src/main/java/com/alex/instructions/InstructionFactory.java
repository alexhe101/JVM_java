package com.alex.instructions;

import com.alex.instructions.base.Instruction;
import com.alex.instructions.comparisons.dcmp.*;
import com.alex.instructions.comparisons.dcmp.*;
import com.alex.instructions.comparisons.fcmp.*;
import com.alex.instructions.comparisons.fcmp.*;
import com.alex.instructions.comparisons.ifacmp.IF_ACMPEQ;
import com.alex.instructions.comparisons.ifacmp.IF_ACMPNE;
import com.alex.instructions.comparisons.ifcond.*;
import com.alex.instructions.comparisons.ificmp.*;
import com.alex.instructions.comparisons.lcmp.*;
import com.alex.instructions.constants.*;
import com.alex.instructions.*;
...
import com.alex.instructions.conversions.i2x.*;
import com.alex.instructions.conversions.l2x.*;
import com.alex.instructions.extended.GOTO_W;
import com.alex.instructions.extended.WIDE;
import com.alex.instructions.extended.ifnull.IFNONNULL;
import com.alex.instructions.extended.ifnull.IFNULL;
import com.alex.instructions.loads.aload.*;
import com.alex.instructions.loads.dload.*;
...
import com.alex.instructions.math.add.*;
import com.alex.instructions.math.add.*;
import com.alex.instructions.math.and.*;
import com.alex.instructions.math.div.*;
import com.alex.instructions.math.iinc.IINC;
import com.alex.instructions.math.mul.*;
import com.alex.instructions.math.neg.*;
import com.alex.instructions.math.or.*;
import com.alex.instructions.math.rem.*;
import com.alex.instructions.math.sh.*;
import com.alex.instructions.math.sub.*;
import com.alex.instructions.math.xor.*;
import com.alex.instructions.references.*;
import com.alex.instructions.stack.dup.*;
import com.alex.instructions.stack.pop.*;
import com.alex.instructions.stack.swap.*;
import com.alex.instructions.stores.astore.*;
import com.alex.instructions.stores.dstore.*;
